...
class opportunity extends Model
{
    ...
    public function estamations(){
        return $this->hasMany(Estamation::class,'opportunity_id','id');
    }
    ...
    public function estimationOppo(){
        return $this->hasMany(EstimationOpportunity::class, 'opportunity_id','id');
    }

    public function invoiceOppo(){
        return $this->hasMany(InvoiceOpportunity::class, 'opportunity_id','id');
    }
     ...
     *
     */
    public function getModelFlgAttribute()
    {
        return false;
    }
}
